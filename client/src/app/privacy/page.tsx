    ...
    return (
        <div className="flex flex-col items-start p-12 text-gray-300">
            ...
            <div className="flex flex-col sm:px-14 gap-4">
                ...
                <p>
                    <p className="mt-4">
                        This privacy policy sets out how Servatom uses and
                        protects any information that you give Servatom when you
                        use this website.
                    </p>
                    <p className="mt-4">
                        Servatom is committed to ensuring that your privacy is
                    ...
                    <p className="mt-4">
                        Servatom may change this policy from time to time by
                    ...
                    <ul className="list-disc list-inside">
                        ...
                        <li className="list-item">
                            Creating your Stripe Customer Account for managing
                            subscriptions.
                        </li>
                        <li className="list-item">
                        ...
                        <li className="list-item">
                            We may periodically send promotional emails about
                        ...
                        <li className="list-item">
                            ...
                            contact you by email or phone. We may use the
                            information to customise the website according to
                            your interests.
                        </li>
                    </ul>
                    <p className="mt-4">
                    ...
                    <p className="mt-4">
                        ...
                        agree, the file is added and the cookie helps analyses
                        web traffic or lets you know when you visit a particular
                    ...
                    <p className="mt-4">
                        We use cookies to store user information for
                        authentication and to provide a better user experience.
                    </p>
                    <p className="mt-4">
                        Overall, cookies help us provide you with a better and
                        personalised website experience. A cookie in no way
                    ...
                    <ul className="list-disc list-inside">
                        ...
                        <li className="list-item">
                            ...
                            you may change your mind at any time by filling the
                            form on the{" "}
                            <a
                                href="/support"
